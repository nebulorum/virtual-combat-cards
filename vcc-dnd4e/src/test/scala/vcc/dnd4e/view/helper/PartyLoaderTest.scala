...
class PartyLoaderTest extends SpecificationWithJUnit with Mockito {
  ...
  "PartyLoader.validatePartyLoadAndWarn" should {
    ...
    "pass partially loaded file if confirmed" in {
    ...
    "block load of partially load file on decline" in {
  ...
  "PartyLoader.resolveEntries" should {
    ...
    "returned resolved entities on confirm accept missing" in {
    ...
    "returned Nil on failed confirm" in {
      peer.confirm("Missing Combatants",
