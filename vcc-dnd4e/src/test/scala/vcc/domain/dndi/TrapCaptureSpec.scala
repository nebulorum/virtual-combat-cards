...
object TrapCaptureSpec extends Specification {
  ...
  "TrapSectionReader" should {
    ...
    "read attack section" in {
      val xmlChunks = List(
        <SPAN class="trapblocktitle" xmlns="http://www.w3.org/1999/xhtml">Attack</SPAN>,
        <SPAN class="trapblockbody" xmlns="http://www.w3.org/1999/xhtml"><B>Immediate Reaction</B> <B>Melee</B> <BR></BR></SPAN>,
        <SPAN class="trapblockbody" xmlns="http://www.w3.org/1999/xhtml"><B>Target: </B>The poor creature.</SPAN>,
        <SPAN class="trapblockbody" xmlns="http://www.w3.org/1999/xhtml"><B>Attack: </B>+8 vs. Reflex</SPAN>,
        (<SPAN class="trapblocktitle" xmlns="http://www.w3.org/1999/xhtml">Countermeasures</SPAN>))

      val tbs = new TrapBlockStream(xmlChunks.map(p=> Parser.parseBlockElement(p, true)))

      val tr = new TrapReader(0, null)
    ...
    "read section with Image ending with a P" in {
      ...
      sec must_== TrapSection("Countermeasures", StyledText(List(
        ...
        //TODO Should preserve more spaces while parsing ' Thie'
    ...
    "handle initiative line" in {
      ...
      //TODO This should be ' +5' need to change import logic to note reformat string.
