...
trait KeystrokeActionable {
   ...
   * @return True if the keystroke was associated 
   */
  def bindKeystrokeAction(keystroke: KeyStroke, action:Action):Boolean = {
    val im=self.peer.getInputMap(javax.swing.JComponent.WHEN_IN_FOCUSED_WINDOW);
